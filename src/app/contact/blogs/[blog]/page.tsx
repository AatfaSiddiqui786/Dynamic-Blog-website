      ...
      <div className="max-w-[100%] mx-auto p-4 border border-gray-300 rounded-md shadow-md min-w-[100%]">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-pink-600 dark:text-white font-bold">
              {
        ...
        <div className="flex justify-center items-center gap-4">
          ...
          <button
            ...
            disabled={isDisable}
            className="px-4 py-2  bg-pink-500 text-white rounded-md hover:bg-pink-600 disabled:bg-pink-400"
          >
            <SendHorizontal />
          </button>
        </div>
        ...
        <ul className="space-y-2 mt-2">
          {useCommentSelector
            ...
            .map((item) => (
              ...
              <div key={item.id}>
                <li
                  className="p-2 border border-pink-200 rounded-md bg-pink-400 dark:text-black text-md w-[100%] break-words"
                ...
                <button
                  ...
                  className="bg-pink-500 text-white text-sm px-2 mt-2 py-1  hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-pink-400 transition duration-200"
                >
                  Remove
                </button>
              </div>
