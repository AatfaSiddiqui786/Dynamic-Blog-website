      ...
      <div className="w-full max-w-2xl flex flex-col-reverse gap-4">
        ...
        <div className="bg-pink-200 dark:bg-pink-200 p-6 rounded-lg shadow-lg text-center text-pink-700">
          ...
          <ul className="space-y-4">
            <li>
              <span className="font-bold">Email:</span> aatfa@gmail.com
            </li>
            <li>
          ...
          <form className="space-y-4">
            <div>
              ...
              <input
                type="text"
                id="name"
                className="w-full px-4 py-2 rounded-md border border-white dark:border-pink-800 bg-white dark:bg-white text-black dark:text-black focus:outline-none focus:ring-2 focus:ring-pink-500 resize-none"
            ...
            <div>
              ...
              <input
                type="email"
                id="email"
                className="w-full px-4 py-2 rounded-md border border-white dark:border-pink-800 bg-white dark:bg-white text-gray-900 dark:text-black focus:outline-none focus:ring-2 focus:ring-pink-500 resize-none"
